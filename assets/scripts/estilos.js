...
styles.setAttribute('href', './assets/styles/style.css');
    ...
    continuacaoFontStatic.crossorigin = '';
        ...
        document.head.append(reset, linkGoogleFontes, continuacaoFontStatic, terceiraParteFontRoboto, terceiraPartOutraLetraIndie, terceiraPartOutraLetraUbuntu, styles);
